...
for Iteration=1:1:200
    ...
    [ARMA_IDE_Length32(:,Iteration),~,~,~,ArOrder32,MaOrder32]=Common_ParameterPsdEst(InputSignal,32,'arma','ideburg','exp',0,4,4);
    [ARMA_IDE_Length64(:,Iteration),~,~,~,ArOrder64,MaOrder64]=Common_ParameterPsdEst(InputSignal,64,'arma','ideburg','exp',0,4,4);
    [ARMA_IDE_Length128(:,Iteration),~,~,~,ArOrder128,MaOrder128]=Common_ParameterPsdEst(InputSignal,128,'arma','ideburg','exp',0,4,4);
    [ARMA_IDE_Length256(:,Iteration),~,~,~,ArOrder256,MaOrder256]=Common_ParameterPsdEst(InputSignal,256,'arma','ideburg','exp',0,4,4);
