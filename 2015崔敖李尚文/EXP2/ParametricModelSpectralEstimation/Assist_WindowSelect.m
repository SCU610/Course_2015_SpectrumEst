function WindowCoeff = Assist_WindowSelect( WindowType,Length )
%Assist_WindowSelect.m 此处显示有关此函数的摘要
%   此处显示详细说明
if Length<1   
    error(message('Error! Invaild Input Length @ Function:"Assist_WindowSelect.m"'));
end
