...
for Iteration=1:1:2
    ...
    [AR_BurgPSD_Length32(:,Iteration)]=Common_ParameterPsdEst(InputSignal,32,'ar','burg',4,0,-4,0);
    [AR_BurgPSD_Length64(:,Iteration)]=Common_ParameterPsdEst(InputSignal,64,'ar','burg',4,0,-4,0);
    [AR_BurgPSD_Length128(:,Iteration)]=Common_ParameterPsdEst(InputSignal,128,'ar','burg',4,0,-4,0);
    [AR_BurgPSD_Length256(:,Iteration)]=Common_ParameterPsdEst(InputSignal,256,'ar','burg',4,0,-4,0);
    
    [AR_BatPSD_Length32(:,Iteration)]=Common_ParameterPsdEst(InputSignal,32,'ar','bat',4,0,-4,0);
    [AR_BatPSD_Length64(:,Iteration)]=Common_ParameterPsdEst(InputSignal,64,'ar','bat',4,0,-4,0);
    [AR_BatPSD_Length128(:,Iteration)]=Common_ParameterPsdEst(InputSignal,128,'ar','bat',4,0,-4,0);
    [AR_BatPSD_Length256(:,Iteration)]=Common_ParameterPsdEst(InputSignal,256,'ar','bat',4,0,-4,0);
end
